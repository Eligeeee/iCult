...
/**
 * Created by Luis Guilherme on 02/09/2017.
 */
...
public abstract class Util {
    ...
    private static final String PASTA_MIDIA ="Pasta_Midia";
    ...
    public static File novaMidia(int tipo){
        String nomeMidia = android.text.format.DateFormat.format("yyyy-MM-dd_hhmmss", new Date()).toString();
    ...
    public static void salverUltimaMidia(Context ctx, int tipo, String midia){
